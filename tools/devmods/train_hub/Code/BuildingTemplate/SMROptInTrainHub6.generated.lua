...
DefineClass.SMROptInTrainHub6 = {
	...
	description = T(909018002004, --[[ModItemBuildingTemplate SMROptInTrainHub6 description]] "A <em>Station</em> where three straight lines cross, so cargo can change routes. It powers itself and six large stations, has its own small <em>Drone</em> crew, and keeps back enough Electronics to maintain itself."),
	build_category = "Stations",
	display_icon = "Mod/SMR_TrainHubDev_20260918/UI/SMROptInTrainHub6_icon_test.png",
	build_pos = 19,
