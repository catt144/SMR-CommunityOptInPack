...
(`B:\Dev\SMR\SMR-BugFixPack\docs\agent\prompts\perma\GAME_PATCH_PROMPT.md`) runs first, always
...
2. Run its command in the fix pack (`B:\Dev\SMR\SMR-BugFixPack`) and confirm the opt-in section
