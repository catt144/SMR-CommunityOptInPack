...
- **Owner, 2026-09-19.** The other pain point of a big network is building it: slow-driving a
  ...
  by dispatching its vehicle to the construction sites. **The gate: a line does not start until it
...
4. **The vehicle** rides out and lays track as it goes, on the same unsaved-prop rule as repair.
