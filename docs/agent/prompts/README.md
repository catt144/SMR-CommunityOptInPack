...
| `TRAIN_HUB_BUILD2_high.md` | `prompt` | **LIVE, fire when ready.** The hub's second build, from the owner's 2026-09-19 smoke-test rulings: drone radius 10 with a tentative slider to 20, the vanilla drone section on the infopanel, and the swap to the owner's asset once they have imported it. Smoke test only (owner) |
