...
| `TRAIN_HUB_TRAINS_high.md` | `prompt` | **HELD at step 0: redesign decision OI-22** (2026-09-20; `GEOMETRY_ORACLE_20260919.md` §12). Build 3b: parking, reverse, lanes, centre turns and occupancy. Gate calculations and alternatives recorded; current six-stop geometry leaves a visible tail and overlaps the connector queue. Resume after the owner's design choice is incorporated into the brief. Owns `20_TrainHub.lua`; build 4 waits behind its smoke. Deleted when its smoke is recorded |
