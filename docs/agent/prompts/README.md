...
| `TRAIN_HUB_LOOK_high.md` | `prompt` | **LIVE: centre fix and relaid body lights prepared, one body re-import and owner look next (2026-09-21).** Owner-approved centre exception is proved and refrozen at paired `hub-centre-uv-frozen-20260921` tags; deterministic UVs and drift rejection remain enforced. Updated BC/NM/RM/SI maps place paired dashes on the outer arms, merge them into a line ending in the portal, and use continuous radiating curves inside. Glass and themed reactor are DEFERRED to a later session; bare siding frames and vanilla FusionReactor are expected. No further body geometry/UV change or dome glass. Survives until owner accepts the look |
