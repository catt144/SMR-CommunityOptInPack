...
| `TRAIN_TESTS_HANDOFF_medium.md` | `prompt` | **LIVE, fire when ready.** Handoff from the 2026-09-17/18 train design session. Run the train spec's §7 no-code tests with the owner (`reports/TRAIN_LOGISTICS_DESIGN_20260917.md`), record the results, re-scope, and author the prototype build prompt only if OI-10 is ruled. No module code |
